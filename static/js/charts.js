function init() {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // Steps 1-3: initialize variables that hold arrays for the sample 
    ...
    var gaugeData = [{
      ...
      gauge: {
        ...
        bordercolor: "gray",
        steps: [
          { range: [0, 2], color: "CCCCCC"},
          { range: [2, 4], color: "FFCC00"},
          { range: [4, 6], color: "FFFF00"},
          { range: [6, 8], color: "66FF00" },
          { range: [8, 10], color: "3333FF" },
        ]},
